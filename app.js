...
function initLogin(){
  ...
  const termsText = `Términos y condiciones – SENDIX\n\n1. Objeto de la Plataforma:\nSENDIX es una plataforma digital que conecta oferta y demanda de transporte de cargas.\nSENDIX no presta servicio de transporte, ni actúa como transportista, ni cómo intermediario financiero.\n\n2. Pagos y Comisiones\n- El valor del flete será acordado directamente entre la Empresa y el Transportista.\n- SENDIX no participa en la transacción económica entre las partes.\n- Por cada viaje confirmado y realizado, SENDIX emitirá factura al transportista por concepto de comisión acumulada en el valor final: 10% sobre el total del viaje.\n- El plazo de pago de dicha comisión será de X días corridos desde la fecha de emisión de la factura.\n- En caso de incumplimiento de pago, se incurrirá en mora automática, aplicándose intereses simples hasta la cancelación total, y además, se restringirá el uso de la plataforma.\n3. Responsabilidad sobre la Carga:\n- La responsabilidad civil y contractual recae exclusivamente en el Transportista contratado, quién deberá contar con el seguro obligatorio vigente.\n- SENDIX no se responsabiliza bajo ninguna circunstancia por la mercadería trasladada, ni por incumplimientos contractuales entre Empresa y Transportista.\n4. Cobertura Adicional:\n- La empresa contratante podrá solicitar cobertura adicional, seleccionando la opción “Solicitar cobertura adicional al transportista”, siendo exclusiva responsabilidad del transportista proveer la póliza correspondiente.\n5. Aceptación:\nLa utilización de la plataforma implica la aceptación plena y sin reservas de los presentes Términos y Condiciones, que constituyen un contrato de adhesión entre SENDIX y sus usuarios.`;
